const defaultProductsInfo = {
  ...
  'HP Workstation': {
    email: 'servers@hp.com',
    price: 4099.95,
    count: 2,
    delivery: {
      Belorus: ['Minsk', 'Brest', 'Grodno']
    }
  },

  'Apple Watch 3': {
    email: 'goods@amazon.com',
    price: 225.55,
    count: 5,
    delivery: {
      Belorus: ['Minsk', 'Grodno'],
  ...
  'iPhone XS 64Gb': {
    email: 'phones@apple.com',
    price: 1020.00,
    count: 23,
    delivery: {
      Russia: ['Saratov', 'St. Petersburg'],
      Belorus: ['Brest', 'Vitebsk']
    }
  }
};
...
/* Render new and existing products */
...
const deliveryCountries = {
  ...
  Belorus: ['Minsk', 'Brest', 'Grodno', 'Gomel', 'Vitebsk'],
...
/* Show modal for edit or delete product */
...
/* Save changes when edit or create new product */
